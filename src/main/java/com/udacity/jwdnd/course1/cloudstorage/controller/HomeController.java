...
public class HomeController {
    ...
    @GetMapping
    public String getHomePage(@RequestParam(required = false) String activeTab, @RequestParam(required = false) boolean isViewingCredential, @RequestParam(required = false) Integer credentialId, Model model, Authentication authentication){
